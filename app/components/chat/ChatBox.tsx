...
import { CompactModelSelector } from '~/components/chat/CompactModelSelector';
    ...
    >
      ...
      >
        <textarea
          ...
          placeholder={props.chatMode === 'build' ? 'Mojo is ready. Are you?' : 'What would you like to discuss?'}
          translate="no"
        />
        <ClientOnly>
          {() => (
